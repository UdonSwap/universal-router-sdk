...
import { Currency, CurrencyAmount, Ether, Token, TradeType } from 'lampros-core'
import { Pool, Route as V3Route, FeeAmount } from 'lampros-v3'
...
export class RouterTradeAdapter {
  ...
  private static isVersionedRoute<T extends V3PoolInRoute>(type: PoolType, route: V3PoolInRoute[]): route is T[] {
